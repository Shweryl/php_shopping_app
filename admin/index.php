...
if (empty($_POST['search']) && empty($_COOKIE['search'])) {
  $stmp = $pdo->prepare("SELECT * FROM products ORDER BY id DESC");
  $stmp->execute();
  ...
  $stmp = $pdo->prepare("SELECT * FROM products WHERE name LIKE '%$searchKey%' ORDER BY id DESC");
  $stmp->execute();
  $rawResults = $stmp->fetchAll();
  $total_pages = ceil(count($rawResults) / $numOfRecord);
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <a href="product_add.php" class="btn btn-success mb-2">New Product</a>
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td class="">
                        <div class="d-flex">
                          <a href="product_edit.php?id=<?php echo $value['id']; ?>" type="button" class="btn btn-info mr-2">Edit</a>
